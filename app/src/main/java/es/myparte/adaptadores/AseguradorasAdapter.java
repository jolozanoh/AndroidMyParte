 ...
 */
public class AseguradorasAdapter extends ArrayAdapter<Aseguradora>
{
    private static class ViewHolder {
        TextView text1;
    }

    public AseguradorasAdapter(Context context, ArrayList<Aseguradora> aseguradorass) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.text1.setText(aseguradora.getAsesor());
