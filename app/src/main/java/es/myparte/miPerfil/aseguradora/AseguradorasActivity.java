...
public class AseguradorasActivity extends ListActivity implements View.OnClickListener{
    public static final String C_MODO = "modo";
    public static final int C_VISUALIZAR = 551;
    public static final int C_CREAR = 552;
    public static final int C_EDITAR = 553;
    public static final int C_ELIMINAR = 554;
    public static final int C_SELECIONAR_A = 104;
    public static final int C_SELECIONAR_B = 110;

    private int modo;
    private AseguradoraDbAdapter dbAdapter;
    private AseguradorasAdapter aseguadorasAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( extra != null ) {
            establecerModo(extra.getInt(AddAseguradora.C_MODO));
    ...
    private void establecerModo(int m) {
        this.modo = m;
        if ((modo == AddAseguradora.C_SELECCIONAR_A)||(modo == AddAseguradora.C_SELECCIONAR_B)) {
            isSeleccionar = true;
        }
    }
    ...
    private void consultar() {
        aseguadorasAdapter = new AseguradorasAdapter(this, dbAdapter.getAseguradoras(filtro));
        lista.setAdapter(aseguadorasAdapter);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if ((modo == AddAseguradora.C_SELECCIONAR_B)){
    ...
    private void visualizar(long id) {
        Intent i = new Intent(AseguradorasActivity.this, AddAseguradora.class);
        i.putExtra(C_MODO, C_VISUALIZAR);
        i.putExtra(AseguradoraDbAdapter.C_COLUMNA_ID, id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            i = new Intent(AseguradorasActivity.this, AddAseguradora.class);
    ...
    private void borrar(final long id) {
        ...
        dialogEliminar.setTitle(getResources().getString(R.string.aseguradora_eliminar_titulo));
        dialogEliminar.setMessage(getResources().getString(R.string.aseguradora_eliminar_mensaje));
        ...
        dialogEliminar.setPositiveButton(getResources().getString(android.R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int boton) {
                dbAdapter.delete(id);
                Toast.makeText(AseguradorasActivity.this, R.string.aseguradora_eliminar_confirmacion, Toast.LENGTH_SHORT).show();
                consultar();
            }
        });
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        if (!isSeleccionar) {
            menu.setHeaderTitle(aseguadorasAdapter.getItem(((AdapterView.AdapterContextMenuInfo) menuInfo).position).getAsesor());
            ...
            if (modo == AddAseguradora.C_SELECCIONAR_A) {
                menu.add(Menu.NONE, C_SELECIONAR_A, Menu.NONE, R.string.menu_seleccionar);
            }else if ( modo == AddAseguradora.C_SELECCIONAR_B){
        ...
        if (!isSeleccionar) {
            switch (item.getItemId()) {
                ...
                case C_EDITAR:
                    ...
                    i.putExtra(AseguradoraDbAdapter.C_COLUMNA_ID, info.id);
